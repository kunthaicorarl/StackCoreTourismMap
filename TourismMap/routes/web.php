...
Route::get('/admin/tourisms/{$id}/e', 'TourismController@e');
Route::get('/admin/tourisms/{$id}/disableDisplay', 'TourismController@disableDisplay');
...
Route::post('/admin/tourisms/enable', 'TourismController@enable');
Route::post('/admin/tourisms/disable', 'TourismController@disable');
